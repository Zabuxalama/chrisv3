...
const hariRaya = new Date('10 7, 2022 00:00:00')
...
let butRun = [
        	...
        	mans.sendMessage(m.chat, { caption: listmn, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: '© Babybot By 𝐑𝐀𝐍𝐙•𝐁𝐎𝐓༽༼𝐙 STORE', templateButtons: butRun, footer: `🌏 Dont Spam & Telpon Bot`, mentionedJid: [m.sender] })
        	break*/
...
case 'me': case 'inventori': case 'profile':{
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     let butRun = [
        	...
        	mans.sendMessage(m.chat, { caption: teksehmazeh, document: { url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx' }, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: '© 𝐑𝐀𝐍𝐙•𝐁𝐎𝐓༽༼𝐙 Store', templateButtons: butRun, footer: `ingin Berpetualang Lagi`, mentions: [m.sender] })
        	}
        	break
        case 'miaw':
        case 'p':
...
hydratedFooterText: "© 𝐑𝐀𝐍𝐙•𝐁𝐎𝐓༽༼𝐙 Bot - X - Miaw Bot",
hydratedButtons: [{
urlButton: {
...
case 'wallpaper': {
		...
		let buttons = [
                ...
                let buttonMessage = {
                    ...
                    footer: `© Created 𝐑𝐀𝐍𝐙•𝐁𝐎𝐓༽༼𝐙 Store`,
                    buttons: buttons,
                    headerType: 4
                }
...
case 'coffe': case 'kopi': {
            let buttons = [
                ...
                let buttonMessage = {
                    ...
                    footer: `Created By © 𝐑𝐀𝐍𝐙•𝐁𝐎𝐓༽༼𝐙 Store`,
                    buttons: buttons,
                    headerType: 4
                }
                mans.sendMessage(m.chat, buttonMessage, { quoted: m })
...
miaw = m.quoted.sender.split("@")[0]
}
const isCwner = owner.includes(miaw)
if (args[0] === "add") {
...
let delcwner = owner.indexOf(miaw)
...
if (!args[0]) return m.reply(`Pilih add atau del`)
if (args[1]) {
miaw = args[1] + "@s.whatsapp.net"
} else if (m.quoted) {
miaw = m.quoted.sender
}
const isBane = banUser.includes(miaw)
if (args[0] === "add") {
...
let delbans = banUser.indexOf(miaw)
...
case 'nulis': {
if (isBan) return m.reply(mess.ban)
if (args.length < 1) return m.reply(`Example :\n${prefix}nulis 𝐑𝐀𝐍𝐙•𝐁𝐎𝐓༽༼𝐙|91|#ff020a|Manusia terganteng adalah salman alfarizi`)
const nls = args.join(" ")
...
mans.setStatus(`Mode : Public Created By 𝐑𝐀𝐍𝐙•𝐁𝐎𝐓༽༼𝐙 Store`)
}
break
case 'setstatut':
case 'setbio':
...
mans.setStatus(`Mode : Self Created By 𝐑𝐀𝐍𝐙•𝐁𝐎𝐓༽༼𝐙 Store`)
}
break
...
case 'iqra': {
		...
		mans.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf By 𝐑𝐀𝐍𝐙•𝐁𝐎𝐓༽༼𝐙 Store`}, {quoted:m}).catch ((err) => m.reply(oh))
		}
		break
		case 'juzamma': {
		if (args[0] === 'pdf') {
...
mans.sendMessage(from, {video:{url:buffer}, mimetype:"video/mp4", caption:"By 𝐑𝐀𝐍𝐙•𝐁𝐎𝐓༽༼𝐙 Store"}, {quoted:m})
break
case 'asupan-santuy':
case 'asupansantuy':
 fakey(mess.wait)
...
.then((a) => {
      ...
      mans.sendMessage(from, { video: { url: dl_link }, caption: "By 𝐑𝐀𝐍𝐙•𝐁𝐎𝐓༽༼𝐙 Store" }, { quoted: m })
      })
